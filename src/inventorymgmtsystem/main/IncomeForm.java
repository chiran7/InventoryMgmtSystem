...
public class IncomeForm extends JFrame {
	 ...
	 * @throws Exception
	 */
	public IncomeForm() throws Exception {
	...
	*/
	private JLabel getLblQuantity() {
		if (lblQuantity == null) {
			...
			lblQuantity.setBounds(51, 25, 78, 14);
		}
		return lblQuantity;
	}
...
System.out.println(fDate);
	     mf.setDate(fDate);
	    // System.out.println(fDate);
//System.out.println(mf.getDate(fDate));
	   ...
	   //  mf.setDate(dateTXT.getText().trim());
		...
		//mf.setIssuedto(String.valueOf(JComboBox.getSelectedItem());
	...
	private JMenu getMnNewMenu() throws Exception {
		if (mnNewMenu == null) {
			mnNewMenu = new JMenu("Income details");
	...
	private JMenuItem getIncomeMenuItem() throws Exception {
		if (incomeMenuItem == null) {
			incomeMenuItem = new JMenuItem("Income PRICE MENU ");
	...
	private JMenuItem getExpenseMenuItem() {
		if (expenseMenuItem == null) {
			expenseMenuItem = new JMenuItem("Exit");
	...
	private JMenu getMnNewMenu_1() {
		if (mnNewMenu_1 == null) {
			mnNewMenu_1 = new JMenu("Back to Main MENU");
	...
	private JMenuItem getProfitMenuItem() {
		if (profitMenuItem == null) {
			profitMenuItem = new JMenuItem("HOME");
			
			profitMenuItem.addActionListener(new ActionListener() {
	...
	*/
	...
	//	mf.setDate(dateTXT.getText().trim());
		...
		try {
			IncomeFormDao dao = new IncomeFormDaoImpl();
	...
	private JComboBox getComboBox() {
		if (comboBox == null) {
			...
			comboBox.setBounds(225, 22, 78, 20);
		}
		return comboBox;
	}
}
